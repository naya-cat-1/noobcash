...
(function(global2, factory) {
  ...
  function useTouch() {
    ...
    const firstMove = React.useRef(null);
  ...
  const Button$1 = (props) => {
    ...
    const plain = React__default["default"].useMemo(() => _plain != null ? _plain : parent == null ? void 0 : parent.plain, [parent == null ? void 0 : parent.plain, _plain]);
    const block = React__default["default"].useMemo(() => _block != null ? _block : parent == null ? void 0 : parent.block, [parent == null ? void 0 : parent.block, _block]);
    const iconPosition = React__default["default"].useMemo(() => _iconPosition || (parent == null ? void 0 : parent.iconPosition) || "left", [parent == null ? void 0 : parent.iconPosition, _iconPosition]);
    const disabled = React__default["default"].useMemo(() => {
      var _a2;
      return (_a2 = props.disabled) != null ? _a2 : parent == null ? void 0 : parent.disabled;
    }, [parent == null ? void 0 : parent.disabled, props.disabled]);
    const nativeType = React__default["default"].useMemo(() => _nativeType || (parent == null ? void 0 : parent.nativeType) || "button", [parent == null ? void 0 : parent.nativeType, _nativeType]);
    ...
    const classes = clsx(className, bem$1C([
      type2,
      size,
      {
        plain,
    ...
    return /* @__PURE__ */ React__default["default"].createElement(TagElement, __spreadProps(__spreadValues({}, restProps), {
      disabled,
      className: classes,
      style,
      type: nativeType,
  ...
  const ButtonGroup = (_a) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      ...
      style,
      className: clsx(className, bem$1B([
        props.type,
        {
          round: props.round,
          plain: props.plain,
  ...
  function mergeProps(...items) {
    const result = __spreadValues({}, items[0]);
    items.forEach((item) => {
  ...
  const IconBase = React__default["default"].forwardRef((props, ref) => {
    ...
    return React__default["default"].cloneElement(children, attrs);
  });
  ...
  const SvgArrowDown = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgArrowDown" }, props, { ref }), React__namespace.createElement(SvgIcon$h, null));
  });
  var ArrowDown = SvgArrowDown;
  ...
  const SvgArrowLeft = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgArrowLeft" }, props, { ref }), React__namespace.createElement(SvgIcon$g, null));
  });
  var ArrowLeft = SvgArrowLeft;
  ...
  const SvgArrowUp = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgArrowUp" }, props, { ref }), React__namespace.createElement(SvgIcon$f, null));
  });
  var ArrowUp = SvgArrowUp;
  ...
  const SvgArrow = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgArrow" }, props, { ref }), React__namespace.createElement(SvgIcon$e, null));
  });
  var Arrow = SvgArrow;
  ...
  const SvgChecked = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgChecked" }, props, { ref }), React__namespace.createElement(SvgIcon$d, null));
  });
  var Checked = SvgChecked;
  ...
  const SvgClear = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgClear" }, props, { ref }), React__namespace.createElement(SvgIcon$c, null));
  });
  var Clear = SvgClear;
  ...
  const SvgClose = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgClose" }, props, { ref }), React__namespace.createElement(SvgIcon$b, null));
  });
  var Close = SvgClose;
  ...
  const SvgCross = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgCross" }, props, { ref }), React__namespace.createElement(SvgIcon$a, null));
  });
  var Cross = SvgCross;
  ...
  const SvgDescription = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgDescription" }, props, { ref }), React__namespace.createElement(SvgIcon$9, null));
  });
  var Description = SvgDescription;
  ...
  const SvgExpandO = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgExpandO" }, props, { ref }), React__namespace.createElement(SvgIcon$8, null));
  });
  var ExpandO = SvgExpandO;
  ...
  const SvgPhotoFail = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgPhotoFail" }, props, { ref }), React__namespace.createElement(SvgIcon$7, null));
  });
  var PhotoFail = SvgPhotoFail;
  ...
  const SvgPhoto = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgPhoto" }, props, { ref }), React__namespace.createElement(SvgIcon$6, null));
  });
  var Photo = SvgPhoto;
  ...
  const SvgPhotograph = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgPhotograph" }, props, { ref }), React__namespace.createElement(SvgIcon$5, null));
  });
  var Photograph = SvgPhotograph;
  ...
  const SvgQuestionO = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgQuestionO" }, props, { ref }), React__namespace.createElement(SvgIcon$4, null));
  });
  var QuestionO = SvgQuestionO;
  ...
  const SvgSearch = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgSearch" }, props, { ref }), React__namespace.createElement(SvgIcon$3, null));
  });
  var SearchIco = SvgSearch;
  ...
  const SvgStarO = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgStarO" }, props, { ref }), React__namespace.createElement(SvgIcon$2, null));
  });
  var StarO = SvgStarO;
  ...
  const SvgStar = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgStar" }, props, { ref }), React__namespace.createElement(SvgIcon$1, null));
  });
  var Star = SvgStar;
  ...
  const SvgSuccess = React__namespace.forwardRef((props, ref) => {
    return React__namespace.createElement(IconBase$1, Object.assign({ name: "SvgSuccess" }, props, { ref }), React__namespace.createElement(SvgIcon, null));
  });
  ...
  const Cell$1 = (props) => {
    ...
    const renderLeftIcon = () => {
      if (props.icon) {
        return React__default["default"].cloneElement(props.icon, {
          className: clsx(bem$1y("left-icon"))
        });
      }
      return null;
    };
    const renderRightIcon = () => {
      ...
      if (props.isLink) {
        ...
        if (props.arrowDirection === "up")
          return /* @__PURE__ */ React__default["default"].createElement(ArrowUp, {
            className: className2
          });
        if (props.arrowDirection === "down")
          return /* @__PURE__ */ React__default["default"].createElement(ArrowDown, {
            className: className2
          });
  ...
  const Popup = React.forwardRef((p2, ref) => {
    ...
    const props = mergeProps(p2, {
      ...
      lockScroll: true,
      position: "center",
      closeIcon: /* @__PURE__ */ React__default["default"].createElement(Cross, null),
  ...
  const Input$1 = React.forwardRef((p2, ref) => {
    ...
    const handleValueChange = (inputValue) => {
      ...
      if (!compositionStartRef.current) {
        if (isDef(maxLength) && finalValue.length > +maxLength) {
          ...
          (_a = props.onOverlimit) == null ? void 0 : _a.call(props);
        }
    ...
    const renderInput = () => {
      ...
      return /* @__PURE__ */ React__default["default"].createElement("input", {
        ...
        onChange: (e2) => {
          var _a;
          return handleValueChange((_a = e2 == null ? void 0 : e2.currentTarget) == null ? void 0 : _a.value);
        },
        ...
        onCompositionEnd: (e2) => {
          ...
          handleValueChange((_b = e2 == null ? void 0 : e2.currentTarget) == null ? void 0 : _b.value);
        },
        onClick: props.onClick
      });
    };
    ...
    }, props.prefix), renderInput(), showClear && React__default["default"].cloneElement(props.clearIcon || /* @__PURE__ */ React__default["default"].createElement(Clear, null), {
  ...
  const Field$1 = React.forwardRef((p2, ref) => {
    ...
    const renderTooltip = () => {
      const { tooltip } = props;
      if (tooltip) {
        let icon = /* @__PURE__ */ React__default["default"].createElement(QuestionO, null);
  ...
  const Flex$1 = (props) => {
    ...
    const getGutter = React.useMemo(() => Array.isArray(gutter) ? gutter : [gutter, gutter], [gutter]);
    ...
    const wrapCls = clsx(className, bem$1o([
      direction,
      wrap,
  ...
  const Space = (props) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      className: clsx(props.className, bem$1m({
        wrap,
        block,
        [`${direction}`]: !!direction,
        [`align-${align}`]: !!align,
  ...
  const Selector = (p2) => {
    ...
    const items = props.options.map((option) => {
      ...
      const itemCls = clsx(bem$1l("item", {
    ...
    const renderContent = () => {
      if (isEnhanceEllipsis)
        return /* @__PURE__ */ React__default["default"].createElement(Ellipsis, __spreadProps(__spreadValues(__spreadValues({
          ...
          className: clsx(className, `rv-typography__${renderType}`, bem$1k([
            type2,
            size,
            {
              center,
  ...
  const Divider = (_e) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", __spreadValues({
      role: "separator",
      className: clsx(className, bem$1i({
        dashed,
        hairline,
  ...
  const Image$1 = (props) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      className: clsx(props.className, bem$1h({
        block,
        round: props.round
      })),
      style,
  ...
  const Skeleton = (_g) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      className: clsx(className, bem$1g({ animate: props.animate, round: props.round })),
      style
  ...
  const LazyImage = (p2) => {
    const props = mergeProps(p2, {
      fit: "fill",
      errorIcon: /* @__PURE__ */ React__default["default"].createElement(PhotoFail, null),
      loadingIcon: /* @__PURE__ */ React__default["default"].createElement(Photo, null),
      showError: true,
      showLoading: true,
      block: true
    });
  ...
  const ImagePreview$1 = React__default["default"].forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      overlay: true,
      showIndex: true,
      images: [],
  ...
  const defaultConfig = {
    ...
    showIndex: true,
    closeable: false,
    closeIcon: /* @__PURE__ */ React__default["default"].createElement(Clear, null),
    startPosition: 0,
    swipeDuration: 300,
    closeOnPopstate: true,
    closeIconPosition: "top-right"
  ...
  const SwipeCell = React.forwardRef((p2, instanceRef) => {
    const props = mergeProps(p2, {
      name: ""
    });
    const opened = React.useRef(false);
  ...
  const NoticeBar = React.forwardRef((p2, ref) => {
    ...
    const getRightIcon = () => {
      if (props.mode === "closeable") {
        return /* @__PURE__ */ React__default["default"].createElement(Cross, null);
      }
      if (props.mode === "link") {
  ...
  const Popover = React.forwardRef((_m, ref) => {
    var _n = _m, { children, className } = _n, p2 = __objRest(_n, ["children", "className"]);
    const props = mergeProps(p2, {
      overlay: false,
      duration: 300,
    ...
    const renderAction = (action, index2) => {
      ...
      return /* @__PURE__ */ React__default["default"].createElement("div", {
        key: index2,
        className: clsx(bem$13("action", { disabled, "with-icon": icon }), actionClassname),
        style: { color },
  ...
  const LoadMore = React__default["default"].forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      threshold: 300
    });
  ...
  const Steps$1 = (_o) => {
    var _p = _o, { children, className, style } = _p, p2 = __objRest(_p, ["children", "className", "style"]);
    const props = mergeProps(p2, {
      active: 0,
  ...
  const StepsItem = (_q) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      style: props.style,
      className: clsx(props.className, BORDER, bem$10([parentProps.direction, { [status]: status }]))
    }, /* @__PURE__ */ React__default["default"].createElement("div", {
  ...
  const DropdownMenu$1 = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      duration: 200,
      overlay: true,
      closeOnClickOutside: true,
    ...
    const renderTitle = (item, index2) => {
      ...
      const childRenderTitle = (itemValue, itemProps) => {
        ...
        const match = itemProps.options.find((option) => option.value === itemValue);
  ...
  const DropdownMenuItem = React.forwardRef((_s, ref) => {
    var _t = _s, { options = [], placeholder = "\u8BF7\u9009\u62E9" } = _t, props = __objRest(_t, ["options", "placeholder"]);
    var _a;
    const [state, setState] = useSetState({
      transition: true,
      showWrapper: false
    ...
    const toggle = (show2 = !props.showPopup, options2 = {}) => {
      if (show2 === props.showPopup) {
        return;
      }
      const newState = {};
      newState.transition = !options2.immediate;
      if (show2) {
    ...
    const renderContent = () => {
      ...
      return /* @__PURE__ */ React__default["default"].createElement("div", {
        ...
        onClose,
        onClosed
      }), options == null ? void 0 : options.map(renderOption), props.children));
    };
    React.useImperativeHandle(ref, () => ({
      toggle,
      renderTitle,
  ...
  const Search = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      shape: "square",
      clearTrigger: "focus",
      leftIcon: /* @__PURE__ */ React__default["default"].createElement(SearchIco, null)
    });
    const { locale } = React.useContext(ConfigProvider$1);
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      className: clsx(props.className, bem$X({ "show-action": props.showAction })),
  ...
  const TabsTitle = React.forwardRef((props, ref) => {
    ...
    const renderText = () => {
      const Title2 = /* @__PURE__ */ React__default["default"].createElement("span", {
        className: clsx(bem$T("text", { ellipsis: !props.scrollable && props.type !== "jumbo" })),
        style: {
      ...
      const measureContent = /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, Title2, Description2);
      if (props.badge) {
  ...
  const SwiperItem = React__default["default"].forwardRef((props, ref) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      ref: wrapperRef,
      className: clsx(props.className, bem$S({
  ...
  const Tabs$1 = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      type: "line",
      duration: 300,
      swipeThreshold: 5,
    ...
    const navStyle = React.useMemo(() => ({
      borderColor: props.type === "card" ? color : void 0,
      background
    }), [color, background]);
    ...
    const [lineTranslateLeft, setLineTranslateLeft] = React.useState(0);
    ...
    }, [root2.current, titleRefs, props.type, index2, childrenList]);
    const lineStyle = React.useMemo(() => {
  ...
  const NavBar = (p2) => {
    const props = mergeProps(p2, {
      border: true,
      leftArrow: /* @__PURE__ */ React__default["default"].createElement(ArrowLeft, null)
    });
    ...
    const renderNavBar = () => {
      ...
      return /* @__PURE__ */ React__default["default"].createElement("div", {
        ref: navBarRef,
        style,
        className: clsx(bem$N({ fixed, "safe-area-inset-top": props.safeAreaInsetTop }), {
  ...
  const Grid = (_w) => {
    var _x = _w, { children, className, style } = _x, p2 = __objRest(_x, ["children", "className", "style"]);
    const props = mergeProps(p2, {
      center: true,
      border: true,
      columnNum: 4
  ...
  const GridItem = (_y) => {
    ...
    const { index: index2 = 0, parent = {} } = props;
    const rootStyle = React.useMemo(() => {
    ...
    const classes = clsx(props.contentClassName, bem$K("content", [
      direction,
      {
        center,
        square,
  ...
  const CollapseItem = React.forwardRef((_A, ref) => {
    var _B = _A, { className, style } = _B, p2 = __objRest(_B, ["className", "style"]);
    const props = mergeProps(p2, {
      isLink: true,
      border: true
    });
  ...
  const Checker = (p2) => {
    ...
    const renderIcon = () => {
      ...
      }, props.iconRender ? props.iconRender({ checked, disabled }) : /* @__PURE__ */ React__default["default"].createElement(Success, {
        style: iconStyle
      }));
    };
    const renderLabel = () => {
  ...
  const Rate = (_C) => {
    ...
    const props = mergeProps(p2, {
      size: 20,
      gutter: 4,
      icon: /* @__PURE__ */ React__default["default"].createElement(Star, null),
      voidIcon: /* @__PURE__ */ React__default["default"].createElement(StarO, null)
    });
  ...
  const Calendar = React.forwardRef((_E, ref) => {
    var _F = _E, { className, style } = _F, p2 = __objRest(_F, ["className", "style"]);
    var _a;
    const props = mergeProps(p2, {
      round: true,
      poppable: true,
    ...
    const onScroll = () => {
      ...
      if (currentMonth && currentMonth.getTitle() !== state.subtitle && !props.horizontal) {
    ...
    const renderMonth = (date2, index2) => {
      const showMonthTitle = !props.horizontal && (index2 !== 0 || !props.showSubtitle);
    ...
    const renderCalendar = () => /* @__PURE__ */ React__default["default"].createElement("div", {
      ...
      indicator: () => null,
      onChange: (index2) => {
        updateState({ subtitle: monthRefs[index2].getTitle() });
      }
    }, months.map((month, index2) => /* @__PURE__ */ React__default["default"].createElement(Swiper.Item, {
      key: month
  ...
  const CascaderPopup = React__default["default"].forwardRef((p2, ref) => {
    var _b;
    const props = mergeProps(p2, {
      closeable: true,
      swipeable: false,
  ...
  const PickerColumn = React.memo(React.forwardRef((props, ref) => {
    ...
    const setIndex = (index2) => {
      ...
      const trigger = () => {
        var _a;
        if (((_a = options[index2]) == null ? void 0 : _a[valueKey]) !== value) {
  ...
  function useColumnsFn(options, keys) {
    ...
    const dataType = React.useMemo(() => {
      const isCascade = options.some((el) => typeof el === "object" && childrenKey in el);
      if (isCascade)
        return "cascade";
  ...
  const DatePicker = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      type: "datetime",
      placeholder: false,
      minDate: DefaultMinDate,
      maxDate: DefaultMaxDate,
      formatter: (type2, value2) => value2
    });
    const _a = props, {
      value,
      defaultValue,
    ...
    const pickerValue = React.useMemo(() => {
      const value2 = props.popup ? formatValue2(currentDateRef.current) : currentDateRef.current;
    ...
    return /* @__PURE__ */ React__default["default"].createElement(Picker, __spreadProps(__spreadValues({}, pickerProps), {
      ...
      var _a2;
      return (_a2 = props.children) == null ? void 0 : _a2.call(props, value || defaultValue, selectRows, actions);
    });
  });
  const currentYear = new Date().getFullYear();
  const DefaultMinDate = new Date(currentYear - 10, 0, 1);
  const DefaultMaxDate = new Date(currentYear + 10, 11, 31);
  const TimePicker = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      minHour: 0,
      maxHour: 23,
      minMinute: 0,
  ...
  const PasswordInput = React.forwardRef((p2, ref) => {
    const props = mergeProps(p2, {
      length: 6,
      gutter: 0,
      mask: true,
  ...
  const NumberKeyboard = (_I) => {
    ...
    const Content = /* @__PURE__ */ React__default["default"].createElement(CSSTransition$1, {
      ...
      className: clsx(className, bem$q({
  ...
  const Slider = (p2) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      ref: root2,
      style: wrapperStyle,
      className: clsx(props.className, bem$p({
  ...
  const Swtich = (p2) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      role: "switch",
      tabIndex: 0,
      className: clsx(props.className, bem$n({
        on: isChecked,
        loading,
        disabled
      })),
  ...
  const Uploader = React.forwardRef((p2, ref) => {
    ...
    const props = mergeProps(p2, {
      ...
      imageFit: "cover",
      resultType: "dataUrl",
      uploadIcon: /* @__PURE__ */ React__default["default"].createElement(Photograph, null)
    });
    const [value, setValue2] = usePropsValue(__spreadProps(__spreadValues({}, props), {
  ...
  const MemoInput = React__default["default"].memo((_M) => {
  ...
  const SkuRowItem = (props) => {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("span", {
      className: clsx(bem$6(classPrefix, {
        active: choosed,
        disabled: !choosable
      })),
      onClick: onSelect
  ...
  const Sku = React.forwardRef((p2, ref) => {
    ...
    const stockContent = React.useMemo(() => {
      ...
      return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, "\u5269\u4F59", /* @__PURE__ */ React__default["default"].createElement("span", {
        className: clsx(bem$3("stock-num", {
    ...
    const renderGroup = () => {
      return props.skuGroup || hasSkuOrAttr && /* @__PURE__ */ React__default["default"].createElement("div", {
        className: clsx(bem$3("group-container", {
  ...
  const FloatingBall = React.forwardRef((p2, ref) => {
    var _a, _b, _c, _d;
    const props = mergeProps(p2, {
  ...
  const FloatingPanel = React.forwardRef((props, ref) => {
    const { className, style, onHeightChange, anchors = [100] } = props;
    const sortAnchors = React.useMemo(() => anchors.sort((a, b2) => a - b2), [anchors]);
    ...
    const [{ visibleH }, api] = useSpring(() => ({
      visibleH: minAnchor,
      config: { tension: 300 },
      onChange: () => onHeightChange == null ? void 0 : onHeightChange(visibleH.get())
    }), [minAnchor]);
    const onTouchStart = (event) => {
      touch.start(event);
    ...
    const onTouchMove = (event) => {
      ...
      if (visibleH.goal >= maxAnchor && bodyEL) {
        if (touch.firstMove.current && (touch.deltaY.current > 0 && getScrollTop$1(bodyEL) > 0 || touch.deltaY.current < 0 && !scrollReachBottom(bodyEL))) {
    ...
    useEventListener("touchmove", onTouchMove, { target: root2, passive: false });
